...
const pages = [
    ...
    { url: 'hakkimizda.php', contentSelector: 'body' },
    { url: 'iletisim.php', contentSelector: 'body' },
    { url: 'ürünler.php', contentSelector: 'body' },
    { url: 'firma1.php', contentSelector: 'body' },
    { url: 'makineparkuru.php', contentSelector: 'body' },
    { url: 'galeri.php', contentSelector: 'body' },
    { url: 'machine1.php', contentSelector: 'body' },
    { url: 'machine2.php', contentSelector: 'body' },
    { url: 'machine3.php', contentSelector: 'body' },
    { url: 'machine4.php', contentSelector: 'body' },
    { url: 'machine5.php', contentSelector: 'body' },
    { url: 'machine6.php', contentSelector: 'body' },
    { url: 'machine7.php', contentSelector: 'body' },
    { url: 'machine8.php', contentSelector: 'body' },
    { url: 'machine9.php', contentSelector: 'body' }
];
