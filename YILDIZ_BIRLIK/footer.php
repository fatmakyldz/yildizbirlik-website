...
<body>
    <footer class="footer">
        <div class="footer-section map">
            <h4>Konum</h4>
            <iframe width="300" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=300&amp;height=200&amp;hl=en&amp;q=Nosab%20112.%20sokak%20numara%20:19%20yıldız%20birlik%20otomat%20+(My%20Business%20Name)&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" allowfullscreen></iframe>
        </div>
        <div class="footer-section contact-info">
            ...
            <div class="info-item">
                ...
                <p>Nilüfer organize sanayi bölgesi 113. sokak no 19 Nilüfer/Bursa/Türkiye</p>
            </div>
            <br>
            <div class="info-item">
                <span class="icon"><i class="fas fa-phone"></i></span>
                <p>+90 (224) 443 11 57</p>
            </div>
            <br>
            <div class="info-item">
                <span class="icon"><i class="fas fa-envelope"></i></span>
                <p>info@yildizbirlik.com.tr</p>
            </div>
            <br>
        ...
        <div class="copyright">
            © 2024 Yıldız Birlik Makina A.Ş. Tüm hakları saklıdır.
        </div>
    </footer>
